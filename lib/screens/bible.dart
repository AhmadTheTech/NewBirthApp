...
class _BibleState extends State<Bible> {
  ...
  Future<void> _initializeData() async {
    try {
      ...
      setState(() {
        error = 'Failed to initialize the store. Please try again later.';
        isLoading = false;
      });
    }
  }
  ...
  void _initializeWebView() {
    controller = WebViewController()
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onWebResourceError: (WebResourceError error) {
            if (mounted) {
              setState(() {
                this.error = 'Failed to load the Bible. Please check your connection.';
                isLoading = false;
              });
            }
          },
      ...
      ..loadRequest(Uri.parse(newBirthLinksData?.bottomBarBibleLink ?? ''));
  }
